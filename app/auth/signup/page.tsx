...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 sm:px-6 py-6 sm:py-12 overflow-hidden">
      {/* Animated gradient background */}
      <div className="absolute inset-0 bg-[#0a0a0f]">
        {/* Gradient orbs */}
        <div className="absolute top-1/3 -right-20 w-48 sm:w-96 h-48 sm:h-96 bg-amber-500/20 rounded-full blur-[80px] sm:blur-[120px] animate-pulse" />
        <div className="absolute bottom-1/3 -left-20 w-48 sm:w-96 h-48 sm:h-96 bg-emerald-500/15 rounded-full blur-[80px] sm:blur-[120px] animate-pulse delay-1000" />
      ...
      <div className="w-full max-w-md space-y-4 sm:space-y-6 relative z-10">
        ...
        <div className="text-center space-y-2 sm:space-y-4">
          ...
          <div className="space-y-1 sm:space-y-2">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white tracking-tight">Create Account</h1>
            <p className="text-sm sm:text-base text-white/60">
              Join researchers and policymakers accessing Nigeria data
            </p>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-amber-500/20 via-transparent to-emerald-500/20 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
          ...
          <div className="relative backdrop-blur-xl bg-white/[0.05] border border-white/[0.1] rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl">
            ...
            <form onSubmit={handleSignUp} className="space-y-3 sm:space-y-4 relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  <Label htmlFor="name" className="text-white/80 text-xs sm:text-sm font-medium">
                    Full Name
                  </Label>
                  <Input
                    id="name"
                    ...
                    className="h-10 sm:h-11 bg-white/[0.05] border-white/[0.1] text-white placeholder:text-white/30 focus:border-amber-500/50 focus:ring-amber-500/20 rounded-xl transition-all text-sm"
                    required
                  />
                </div>
                ...
                {/* Organization field */}
                <div className="space-y-1.5 sm:space-y-2">
                  <Label htmlFor="organization" className="text-white/80 text-xs sm:text-sm font-medium">
                    Organization
                  </Label>
                  <Input
                    id="organization"
              ...
              {/* Error message */}
              {error && (
                <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/20 text-sm text-red-400 backdrop-blur-sm">
                  {error}
                </div>
              )}
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-12 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-white font-semibold rounded-xl shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-all gap-2 mt-2"
              >
                {loading ? (
                  <>
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-3 bg-transparent text-white/40">Or sign up with</span>
              </div>
            </div>
        ...
        <div className="text-center text-sm">
          ...
          <Link href="/auth/signin" className="text-amber-400 hover:text-amber-300 font-medium transition">
            Sign in
          </Link>
        </div>
